...
const Contacts = () => {
  ...
  useEffect(() => {
    ...
    setTimeout(() => setIsVisible(prev => [...prev.slice(0,3), true]), 2100);
  }, []);
    const sectionData = [
        {
...
<section className={`${styles.mapAndFormSection} ${isVisible[3] ? styles.fadeIn : styles.hidden}`}>
    ...
    <div className={styles.directContact}>
        <div className={styles.iconContainer}>
            <FaPhone size={35} className={styles.icon}/>
            <p>+123 456 7890</p>
        </div>
        <div className={styles.iconContainer}>
            <FaEnvelope size={35} className={styles.icon}/>
            <p>email@phoeniquelife.com</p>
        </div>
        <div className={styles.iconContainer}>
            <FaWhatsapp size={35} className={styles.icon}/>
            <p>+123 456 7890</p>
        </div>
        <div className={styles.iconContainer}>
